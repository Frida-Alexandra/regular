...
def fix(contact_list: list):
    ...
    return emptiness_inside(new_list)

def emptiness_inside(contacts: list):
    ...
    result_phonebook = list()
    for i in contacts:
        if i not in result_phonebook:
            result_phonebook.append(i)
    return result_phonebook
